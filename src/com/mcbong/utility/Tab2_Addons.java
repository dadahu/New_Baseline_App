                    ...
                    custom_alert_dialog_ok.setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            ...
                            request.setDestinationInExternalPublicDir(
                                    Environment.DIRECTORY_DOWNLOADS, "ADW-Launcher.apk");
                            ...
                            Toast.makeText(activity, R.string.downloading_launcher,
                ...
                if (activity != null) {
                    ...
                    custom_alert_dialog_ok.setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            ...
                            request.setDestinationInExternalPublicDir(
                                    Environment.DIRECTORY_DOWNLOADS, "Go-Launcher.apk");
                ...
                if (activity != null) {
                    ...
                    custom_alert_dialog_ok.setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            ...
                            request.setDestinationInExternalPublicDir(
                                    Environment.DIRECTORY_DOWNLOADS, "Nova-Launcher.apk");
                ...
                if (activity != null) {
                    ...
                    custom_alert_dialog_ok.setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            ...
                            request.setDestinationInExternalPublicDir(
                                    Environment.DIRECTORY_DOWNLOADS, "ssdred.apk");
                            ...
                            BroadcastReceiver onComplete = new BroadcastReceiver() {
                                public void onReceive(Context ctxt, Intent intent) {
                                    Toast.makeText(ctxt, R.string.installing_theme,
                                            Toast.LENGTH_SHORT).show();
                                    Intent install = new Intent(Intent.ACTION_VIEW);
                                    install.setDataAndType(Uri.fromFile(new File(Environment
                                            .getExternalStorageDirectory()
                ...
                if (activity != null) {
                    ...
                    custom_alert_dialog_ok.setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            ...
                            request.setDestinationInExternalPublicDir(
                                    Environment.DIRECTORY_DOWNLOADS, "popstyle.apk");
                ...
                if (activity != null) {
                    ...
                    custom_alert_dialog_ok.setOnClickListener(new OnClickListener() {
                        public void onClick(View v) {
                            ...
                            request.setDestinationInExternalPublicDir(
                                    Environment.DIRECTORY_DOWNLOADS, "redics.apk");
